 ...
 *
 * @author Taieb Sabri (codetemp), http://ddabout.com
 *
 * @since 1.0.0
 *
 * Required WP 3.5+ (*)
 ...
 * --- You Have To Purchase A Licence From ddabout.com@gmail.com
 *
 /*********************************************************************************************************/
	...
	class ctf_setup extends ctf_options
	{
		...
		public function get_html_footer()
		{
			...
			$html .=' 	<div class="codetemp_footer">
							...
							<span>'.date('Y').' &copy; Build By CTFramework , <a href="http://ddabout.com">ddabout.com</a></span>
