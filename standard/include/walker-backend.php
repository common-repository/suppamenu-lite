                        ...
                        <div class="admin_suppa_box admin_suppa_box_menu_type" >
                            ...
                            <div class="admin_suppa_box_container">
                                ...
                                <div class="admin_suppa_box_menu_item_types">
                                    ...
                                    <select class="suppa_menu_type <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>">
                                        <option <?php if($menu_type=="dropdown") echo "selected"; ?> value="dropdown"><?php _e('Use as DropDown','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="links") echo "selected"; ?> value="links"><?php _e('Use as Mega Links','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="links_style_two") echo "selected"; ?> value="links_style_two"><?php _e('Use as Mega Links {2}','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="posts") echo "selected"; ?> value="posts"><?php _e('Use as Recent Posts','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="mega_posts") echo "selected"; ?> value="mega_posts"><?php _e('Use as Mega Posts','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="html") echo "selected"; ?> value="html"><?php _e('Use as HTML &amp; Shortcodes','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="search") echo "selected"; ?> value="search"><?php _e('Use as Search Form','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="social") echo "selected"; ?> value="social"><?php _e('Use as Social Media','suppa_menu'); ?></option>
                                        <option <?php if($menu_type=="woocommerce_cart") echo "selected"; ?> value="woocommerce_cart"><?php _e('Use as Woocommerce Cart','suppa_menu'); ?></option>
                                    </select>
                                ...
                                <div <?php if( 'links_style_two' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_links_style_two">
                                    ...
                                    <span><?php echo $title; ?> </span>
                                    <input type="text" id="edit-<?php echo $key.'-'.$item_id; ?>" class="<?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" value="<?php echo $value; ?>" />
                                ...
                                <div <?php if( 'dropdown' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_dropdown">
                                    ...
                                    <input maxlength="7" type="text" value="<?php echo $value; ?>" id="edit-<?php echo $key.'-'.$item_id; ?>" class="<?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" />
                                    ...
                                    <br/>
                                    <span class="fl" ><?php echo $title; ?></span>
                                    <input <?php echo $checked; ?> type="checkbox" value="on" id="edit-<?php echo $key.'-'.$item_id; ?>" class="<?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" />
                                ...
                                <div <?php if( 'html' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_html">
                                    ...
                                    <?php echo $title; ?>
                                    <div>
                                        <input <?php echo $checked; ?> type="checkbox" value="<?php echo $fullwidth; ?>" id="edit-<?php echo $key.'-'.$item_id; ?>" class="admin_suppa_fullwidth_checkbox <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" />
                                    </div>
                            ...
                            <div class="admin_suppa_box_container admin_suppa_box_container_settings">
                                ...
                                <div id="menu-item-suppa-link_icon_only">
                                    ...
                                    <label for="edit-<?php echo $key.'-'.$item_id; ?>">
                                        ...
                                        <?php echo $title; ?>
                                        <input <?php if( $value == 'on' ) echo 'checked'; ?> type="checkbox" value="<?php echo $value; ?>" id="edit-<?php echo $key.'-'.$item_id; ?>" class="suppa_use_icon_only <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" />
